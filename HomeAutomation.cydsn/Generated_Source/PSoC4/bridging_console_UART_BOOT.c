/***************************************************************************//**
* \file bridging_console_UART_BOOT.c
* \version 4.0
*
* \brief
...
/*******************************************************************************
* Function Name: bridging_console_UartCyBtldrCommStart
****************************************************************************//**
*
...
{
    bridging_console_Start();
}


/*******************************************************************************
* Function Name: bridging_console_UartCyBtldrCommStop
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: bridging_console_UartCyBtldrCommReset
****************************************************************************//**
*
...
void bridging_console_UartCyBtldrCommReset(void)
{
    ...
    bridging_console_SpiUartClearRxBuffer();
    bridging_console_SpiUartClearTxBuffer();
}


/*******************************************************************************
* Function Name: bridging_console_UartCyBtldrCommRead
****************************************************************************//**
*
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        do
        {
            ...
            if (0u != bridging_console_SpiUartGetRxBufferSize())
            {
                ...
                do
                {
                    byteCount = bridging_console_SpiUartGetRxBufferSize();
                    CyDelayUs(bridging_console_UART_BYTE_TO_BYTE);
                }
                while (byteCount != bridging_console_SpiUartGetRxBufferSize());

                byteCount = bridging_console_BYTES_TO_COPY(byteCount, size);
            ...
            CyDelay(bridging_console_WAIT_1_MS);
            --timeoutMs;
        }
        while (0u != timeoutMs);
        ...
        {
            pData[i] = (uint8) bridging_console_SpiUartReadRxData();
        }
    }
...
/*******************************************************************************
* Function Name: bridging_console_UartCyBtldrCommWrite
****************************************************************************//**
*
...
cystatus bridging_console_UartCyBtldrCommWrite(const uint8 pData[], uint16 size, uint16 * count, uint8 timeOut)
{
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        bridging_console_SpiUartPutArray(pData, (uint32) size);
