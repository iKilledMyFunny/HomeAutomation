...
***************************************/
    ...
    #define console_RX_SCL_MOSI_HSIOM_SEL_GPIO  (console_uart_rx_i2c_scl_spi_mosi__0__HSIOM_GPIO)
    #define console_RX_SCL_MOSI_HSIOM_SEL_I2C   (console_uart_rx_i2c_scl_spi_mosi__0__HSIOM_I2C)
    #define console_RX_SCL_MOSI_HSIOM_SEL_SPI   (console_uart_rx_i2c_scl_spi_mosi__0__HSIOM_SPI)
    #define console_RX_SCL_MOSI_HSIOM_SEL_UART  (console_uart_rx_i2c_scl_spi_mosi__0__HSIOM_UART)
    
#elif (console_RX_WAKE_SCL_MOSI_PIN)
    #define console_RX_WAKE_SCL_MOSI_HSIOM_REG   (*(reg32 *) console_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM)
    #define console_RX_WAKE_SCL_MOSI_HSIOM_PTR   ( (reg32 *) console_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM)
    
    #define console_RX_WAKE_SCL_MOSI_HSIOM_MASK      (console_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_MASK)
    #define console_RX_WAKE_SCL_MOSI_HSIOM_POS       (console_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_SHIFT)
    #define console_RX_WAKE_SCL_MOSI_HSIOM_SEL_GPIO  (console_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_GPIO)
    #define console_RX_WAKE_SCL_MOSI_HSIOM_SEL_I2C   (console_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_I2C)
    #define console_RX_WAKE_SCL_MOSI_HSIOM_SEL_SPI   (console_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_SPI)
    #define console_RX_WAKE_SCL_MOSI_HSIOM_SEL_UART  (console_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_UART)    
   
    #define console_RX_WAKE_SCL_MOSI_INTCFG_REG (*(reg32 *) console_uart_rx_wake_i2c_scl_spi_mosi__0__INTCFG)
    #define console_RX_WAKE_SCL_MOSI_INTCFG_PTR ( (reg32 *) console_uart_rx_wake_i2c_scl_spi_mosi__0__INTCFG)
    #define console_RX_WAKE_SCL_MOSI_INTCFG_TYPE_POS  (console_uart_rx_wake_i2c_scl_spi_mosi__SHIFT)
    #define console_RX_WAKE_SCL_MOSI_INTCFG_TYPE_MASK ((uint32) console_INTCFG_TYPE_MASK << \
                                                                           console_RX_WAKE_SCL_MOSI_INTCFG_TYPE_POS)
#else
    /* None of pins console_RX_SCL_MOSI_PIN or console_RX_WAKE_SCL_MOSI_PIN present.*/
    ...
    #define console_TX_SDA_MISO_HSIOM_SEL_GPIO  (console_uart_tx_i2c_sda_spi_miso__0__HSIOM_GPIO)
    #define console_TX_SDA_MISO_HSIOM_SEL_I2C   (console_uart_tx_i2c_sda_spi_miso__0__HSIOM_I2C)
    #define console_TX_SDA_MISO_HSIOM_SEL_SPI   (console_uart_tx_i2c_sda_spi_miso__0__HSIOM_SPI)
    #define console_TX_SDA_MISO_HSIOM_SEL_UART  (console_uart_tx_i2c_sda_spi_miso__0__HSIOM_UART)
