...
#define console_COMP_VERSION_MAJOR    (4)
#define console_COMP_VERSION_MINOR    (0)
...
/* Interface to internal interrupt component */
    ...
    */    
    /*******************************************************************************
    * Function Name: console_EnableInt
    ****************************************************************************//**
    *
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: console_DisableInt
    ****************************************************************************//**
    *
    ...
    *******************************************************************************/    
    ...
    /*******************************************************************************
    * Function Name: console_ClearPendingInt
    ****************************************************************************//**
    *
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: console_RxWakeEnableInt
    ****************************************************************************//**
    *
    ...
    *******************************************************************************/    
    ...
    /*******************************************************************************
    * Function Name: console_RxWakeDisableInt
    ****************************************************************************//**
    *
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: console_RxWakeClearPendingInt
    ****************************************************************************//**
    *
...
/* Get interrupt cause */
/*******************************************************************************
* Function Name: console_GetInterruptCause
****************************************************************************//**
*
...
*    - console_INTR_CAUSE_MASTER - Interrupt from Master
*    - console_INTR_CAUSE_SLAVE - Interrupt from Slave
*    - console_INTR_CAUSE_TX - Interrupt from TX
*    - console_INTR_CAUSE_RX - Interrupt from RX
*
*******************************************************************************/
...
/*******************************************************************************
* Function Name: console_GetRxInterruptSource
****************************************************************************//**
*
...
*   - console_INTR_RX_FIFO_LEVEL - The number of data elements in the 
      RX FIFO is greater than the value of RX FIFO level.
*   - console_INTR_RX_NOT_EMPTY - Receiver FIFO is not empty.
*   - console_INTR_RX_FULL - Receiver FIFO is full.
*   - console_INTR_RX_OVERFLOW - Attempt to write to a full 
*     receiver FIFO.
*   - console_INTR_RX_UNDERFLOW - Attempt to read from an empty 
*     receiver FIFO.
*   - console_INTR_RX_FRAME_ERROR - UART framing error detected.
*   - console_INTR_RX_PARITY_ERROR - UART parity error detected.
*
*******************************************************************************/
...
/*******************************************************************************
* Function Name: console_SetRxInterruptMode
****************************************************************************//**
*
...
*   console_GetRxInterruptSource() function for bit fields values).
*
*******************************************************************************/
...
/*******************************************************************************
* Function Name: console_GetRxInterruptMode
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: console_GetRxInterruptSourceMasked
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: console_ClearRxInterruptSource
****************************************************************************//**
*
...
*   - console_INTR_RX_FIFO_LEVEL Interrupt source is not cleared when 
*     the receiver FIFO has more entries than level.
*   - console_INTR_RX_NOT_EMPTY Interrupt source is not cleared when
*     receiver FIFO is not empty.
*   - console_INTR_RX_FULL Interrupt source is not cleared when 
...
/*******************************************************************************
* Function Name: console_SetRxInterrupt
****************************************************************************//**
*
...
*   register (refer to console_GetRxInterruptSource() function for bit 
*   fields values).
*
*******************************************************************************/
...
/*******************************************************************************
* Function Name: console_GetTxInterruptSource
****************************************************************************//**
*
...
*   Each constant is a bit field value. The value returned may have multiple 
*   bits set to indicate the current status.
*   - console_INTR_TX_FIFO_LEVEL - The number of data elements in the 
*     TX FIFO is less than the value of TX FIFO level.
*   - console_INTR_TX_NOT_FULL - Transmitter FIFO is not full.
*   - console_INTR_TX_EMPTY - Transmitter FIFO is empty.
*   - console_INTR_TX_OVERFLOW - Attempt to write to a full 
*     transmitter FIFO.
*   - console_INTR_TX_UNDERFLOW - Attempt to read from an empty 
*     transmitter FIFO.
*   - console_INTR_TX_UART_NACK - UART received a NACK in SmartCard 
*   mode.
*   - console_INTR_TX_UART_DONE - UART transfer is complete. 
*     All data elements from the TX FIFO are sent.
*   - console_INTR_TX_UART_ARB_LOST - Value on the TX line of the UART
...
/*******************************************************************************
* Function Name: console_SetTxInterruptMode
****************************************************************************//**
*
...
*   console_GetTxInterruptSource() function for bit field values).
*
*******************************************************************************/
...
/*******************************************************************************
* Function Name: console_GetTxInterruptMode
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: console_GetTxInterruptSourceMasked
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: console_ClearTxInterruptSource
****************************************************************************//**
*
...
*   - console_INTR_TX_FIFO_LEVEL - Interrupt source is not cleared when 
*     transmitter FIFO has less entries than level.
*   - console_INTR_TX_NOT_FULL - Interrupt source is not cleared when
*     transmitter FIFO has empty entries.
*   - console_INTR_TX_EMPTY - Interrupt source is not cleared when 
*     transmitter FIFO is empty.
*   - console_INTR_TX_UNDERFLOW - Interrupt source is not cleared when 
...
/*******************************************************************************
* Function Name: console_SetTxInterrupt
****************************************************************************//**
*
*  Sets RX interrupt sources in the interrupt request register.
*
...
/*******************************************************************************
* Function Name: console_GetMasterInterruptSource
****************************************************************************//**
*
...
*   Each constant is a bit field value. The value returned may have multiple 
*   bits set to indicate the current status.
*   - console_INTR_MASTER_SPI_DONE - SPI master transfer is complete.
*     Refer to Interrupt sources section for detailed description.
*   - console_INTR_MASTER_I2C_ARB_LOST - I2C master lost arbitration.
*   - console_INTR_MASTER_I2C_NACK - I2C master received negative 
*    acknowledgement (NAK).
*   - console_INTR_MASTER_I2C_ACK - I2C master received acknowledgement.
*   - console_INTR_MASTER_I2C_STOP - I2C master generated STOP.
*   - console_INTR_MASTER_I2C_BUS_ERROR - I2C master bus error 
...
/*******************************************************************************
* Function Name: console_SetMasterInterruptMode
****************************************************************************//**
*
...
*   console_GetMasterInterruptSource() function for bit field values).
*
*******************************************************************************/
#define console_SetMasterInterruptMode(interruptMask)  console_WRITE_INTR_MASTER_MASK(interruptMask)

/*******************************************************************************
* Function Name: console_GetMasterInterruptMode
****************************************************************************//**
*
...
*   console_GetMasterInterruptSource() function for return values).
*
*******************************************************************************/
#define console_GetMasterInterruptMode()   (console_INTR_MASTER_MASK_REG)

/*******************************************************************************
* Function Name: console_GetMasterInterruptSourceMasked
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: console_ClearMasterInterruptSource
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: console_SetMasterInterrupt
****************************************************************************//**
*
*  Sets Master interrupt sources in the interrupt request register.
*
*  \param interruptMask: Master interrupt sources to set in the Master interrupt
*   request register (refer to console_GetMasterInterruptSource() 
...
/*******************************************************************************
* Function Name: console_GetSlaveInterruptSource
****************************************************************************//**
*
...
*   Each constant is a bit field value. The value returned may have multiple 
*   bits set to indicate the current status.
*   - console_INTR_SLAVE_I2C_ARB_LOST - I2C slave lost arbitration: 
*     the value driven on the SDA line is not the same as the value observed 
*     on the SDA line.
*   - console_INTR_SLAVE_I2C_NACK - I2C slave received negative 
*     acknowledgement (NAK).
*   - console_INTR_SLAVE_I2C_ACK - I2C slave received 
*     acknowledgement (ACK).
*   - console_INTR_SLAVE_I2C_WRITE_STOP - Stop or Repeated Start 
*     event for write transfer intended for this slave (address matching 
*     is performed).
*   - console_INTR_SLAVE_I2C_STOP - Stop or Repeated Start event 
*     for (read or write) transfer intended for this slave (address matching 
*     is performed).
*   - console_INTR_SLAVE_I2C_START - I2C slave received Start 
*     condition.
*   - console_INTR_SLAVE_I2C_ADDR_MATCH - I2C slave received matching 
*     address.
*   - console_INTR_SLAVE_I2C_GENERAL - I2C Slave received general 
*     call address.
*   - console_INTR_SLAVE_I2C_BUS_ERROR - I2C slave bus error (detection 
*      of unexpected Start or Stop condition).
*   - console_INTR_SLAVE_SPI_BUS_ERROR - SPI slave select line is 
...
/*******************************************************************************
* Function Name: console_SetSlaveInterruptMode
****************************************************************************//**
*
...
*   console_GetSlaveInterruptSource() function for bit field values).
*
*******************************************************************************/
#define console_SetSlaveInterruptMode(interruptMask)   console_WRITE_INTR_SLAVE_MASK(interruptMask)

/*******************************************************************************
* Function Name: console_GetSlaveInterruptMode
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: console_GetSlaveInterruptSourceMasked
****************************************************************************//**
*
...
*   console_GetSlaveInterruptSource() function for return values).
*
*******************************************************************************/
#define console_GetSlaveInterruptSourceMasked()    (console_INTR_SLAVE_MASKED_REG)

/*******************************************************************************
* Function Name: console_ClearSlaveInterruptSource
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: console_SetSlaveInterrupt
****************************************************************************//**
*
*  Sets Slave interrupt sources in the interrupt request register.
*
*  \param interruptMask: Slave interrupt sources to set in the Slave interrupt 
*   request register (refer to console_GetSlaveInterruptSource() 
...
#ifdef console_SCB__EZ_DATA0
    #define console_EZBUF_DATA0_REG    (*(reg32 *) console_SCB__EZ_DATA0)
    #define console_EZBUF_DATA0_PTR    ( (reg32 *) console_SCB__EZ_DATA0)
#else
    #define console_EZBUF_DATA0_REG    (*(reg32 *) console_SCB__EZ_DATA00)
    #define console_EZBUF_DATA0_PTR    ( (reg32 *) console_SCB__EZ_DATA00)
#endif /* console_SCB__EZ_DATA00 */
...
#define console_FIFO_SIZE      (8u)  /* TX or RX FIFO size. */
#define console_EZ_DATA_NR     (32u)  /* Number of words in EZ memory. */ 
#define console_ONE_BYTE_WIDTH (8u)            /* Number of bits in one byte. */
#define console_FF_DATA_NR_LOG2_MASK       (0x0Fu)      /* Number of bits to represent a FIFO address. */
#define console_FF_DATA_NR_LOG2_PLUS1_MASK (0x1Fu) /* Number of bits to represent #bytes in FIFO. */
...
*/
#define console_SCB_SW_RESET   console_I2CFwBlockReset()
...
#define console_DISABLE_AUTO_DATA \
                do{                        \
                    console_I2C_CTRL_REG &= ((uint32) ~(console_I2C_CTRL_M_READY_DATA_ACK      |  \
                                                                 console_I2C_CTRL_M_NOT_READY_DATA_NACK |  \
                                                                 console_I2C_CTRL_S_READY_DATA_ACK      |  \
                                                                 console_I2C_CTRL_S_NOT_READY_DATA_NACK)); \
                }while(0)
...
#define console_GET_UART_RX_CTRL_BREAK_WIDTH(width)    (((uint32) ((uint32) (width) - 1u) << \
                                                                    console_UART_RX_CTRL_BREAK_WIDTH_POS) & \
                                                                    console_UART_RX_CTRL_BREAK_WIDTH_MASK)
...
#define console_GET_TX_CTRL_DATA_WIDTH(dataWidth)  (((uint32) (dataWidth) - 1u) & \
                                                                console_TX_CTRL_DATA_WIDTH_MASK)
...
#define console_EZBUFFER_SIZE          (console_EZ_DATA_NR)

#define console_EZBUF_DATA00_REG   console_EZBUF_DATA0_REG
#define console_EZBUF_DATA00_PTR   console_EZBUF_DATA0_PTR
