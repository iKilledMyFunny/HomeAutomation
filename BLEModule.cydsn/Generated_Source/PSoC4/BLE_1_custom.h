...
#define CYBLE_HOMEAUTOMATION_SERVICE_INDEX   (0x00u) /* Index of HomeAutomation service in the cyBle_customs array */
#define CYBLE_HOMEAUTOMATION_LED_CHAR_INDEX   (0x00u) /* Index of LED characteristic */
#define CYBLE_HOMEAUTOMATION_LED_CCCD_DESC_INDEX   (0x00u) /* Index of CCCD descriptor */


#define CYBLE_HOMEAUTOMATION_SERVICE_HANDLE   (0x0010u) /* Handle of HomeAutomation service */
#define CYBLE_HOMEAUTOMATION_LED_DECL_HANDLE   (0x0011u) /* Handle of LED characteristic declaration */
#define CYBLE_HOMEAUTOMATION_LED_CHAR_HANDLE   (0x0012u) /* Handle of LED characteristic */
#define CYBLE_HOMEAUTOMATION_LED_CCCD_DESC_HANDLE   (0x0013u) /* Handle of CCCD descriptor */
