...
CYBLE_GAPP_DISC_PARAM_T cyBle_discoveryParam =
{
    ...
    {0xEFu, 0xCDu, 0xABu, 0x50u, 0xA0u, 0x00u}, /* uint8* direct_addr */
...
{
    { 0x02u, 0x01u, 0x06u, 0x0Au, 0x09u, 0x42u, 0x6Cu,
    0x65u, 0x53u, 0x77u, 0x69u, 0x74u, 0x63u, 0x68u, 0x03u,
    0x03u, 0x42u, 0xC0u, 0x03u, 0x16u, 0x42u, 0xC0u, 0x00u,
...
CYBLE_GAP_BD_ADDR_T cyBle_deviceAddress = {{0xEFu, 0xCDu, 0xABu, 0x50u, 0xA0u, 0x00u}, 0x00u };
